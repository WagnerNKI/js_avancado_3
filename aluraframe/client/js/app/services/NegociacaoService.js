        ...
        execute: function () {
            ...
            _export('NegociacaoService', NegociacaoService = function () {
                ...
                _createClass(NegociacaoService, [{
                    ...
                    key: 'obterNegociacoesGeral',
                    value: function obterNegociacoesGeral() {
                    ...
                    value: function cadastrar(negociacao) {
                        return ConnectionFactory.getConnection().then(function (connection) {
                            ...
                            return 'Negociaçao adicionada com sucesso';
                        }).catch(function (erro) {
                            console.log(erro);
                    ...
                    value: function apaga() {
                        return ConnectionFactory.getConnection().then(function (connection) {
                            ...
                            return 'Negociacões apagadas com sucesso';
                        }).catch(function () {
                            console.log(erro);
                    ...
                    value: function importa(listaAtual) {
                        ...
                        return this.obterNegociacoesGeral().then(function (negociacoes) {
