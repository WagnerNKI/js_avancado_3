        ...
        execute: function () {
            ...
            NegociacaoController = function () {
                function NegociacaoController() {
                    ...
                    this._listaNegociacoes = new Bind(new ListaNegociacoes(), new NegociacoesView($('#negociacoesView')), 'adiciona', 'esvazia', 'ordena', 'inveterOrdem');
                ...
                _createClass(NegociacaoController, [{
                    ...
                    value: function _init() {
                        ...
                        this._service.lista().then(function (negociacoes) {
                            ...
                            console.log(erro);
                            _this._mensagem.texto = 'Não foi possíivel obter as negociações';
                        });
                    ...
                    value: function adiciona(event) {
                        ...
                        new NegociacaoService().cadastrar(negociacao).then(function (mensagem) {
                            ...
                            return _this2.mensagem.texto = erro;
                        });
                    }
                }, {
